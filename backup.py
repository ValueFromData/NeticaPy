...
UnitPrice = N.NewNode_bn("UnitPrice", 7, bayesian_network)
...
N.SetNodeStateNames_bn(UnitPrice, "p1600,p1650,p1700,p1750,p1800,p1850,p1900")
...
N.SetNodeFuncState (UnitPrice,6,"*")
